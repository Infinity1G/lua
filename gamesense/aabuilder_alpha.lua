...
local function set_references_visibility(b)
    set_table_visibility(references.pitch, references.yaw_base, references.yaw, references.yaw_val, references.jitter, references.jitter_val, references.body, references.body_val, references.freestand_body, references.fake_limit, references.roll, references.edge_yaw, references.freestanding, references.freestanding_key, false)
end
...
local function on_init()
    ...
    ui_set_callback(menu.delete, function() table_remove(blocks, ui_get(menu.browser)+1); update_browser() end)
    ...
    ui_set_callback(menu.back2, function() current_block:update(); update_visibility(0) end)
